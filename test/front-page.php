			...
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="present_img">
						<img src="<?php echo get_template_directory_uri(); ?>/images/image-1.png" width="300" alt="image">
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="features_img pull-left">
						<img src="<?php echo get_template_directory_uri(); ?>/images/features_img.png" width="300" alt="image">
					</div>
				</div>
			...
			<div class="col-md-12">
				...
				<div class="col-md-7">
					<div class="services_img">
						<img src="<?php echo get_template_directory_uri(); ?>/images/services_img1.png" width="300" alt="image">
					</div>
						
					<div class="services_img_n">
						<img src="<?php echo get_template_directory_uri(); ?>/images/services_img2.png" width="300" alt="image">
					</div>
				</div>
			...
			<div class="col-md-12">
				...
				<div class="col-md-4">
								<div class="workng_img">
									<img src="<?php echo get_template_directory_uri(); ?>/images/how_to_work.png" width="300" alt="image">
								</div>
				</div>
			...
			<div class="col-md-12">
				...
				<div class="section_heading">
					...
					<div class="portfolio_img">
						<div class="port_img1">
							<img src="<?php echo get_template_directory_uri(); ?>/images/portfolio2.png" width="300" alt="image">
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-3">
					<div class="member_detail">
						<div class="member_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/member_1.png" width="300" alt="image">
						</div>
				...
				<div class="col-md-3">
					<div class="member_detail">
						<div class="member_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/member_2.png" width="300" alt="image">
						</div>
						<div class="member_name">
							<h5> Marlon Leend</h5>
							<p> Head Phographer</p>
				...
				<div class="col-md-3">
					<div class="member_detail">
						<div class="member_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/member_3.png" width="300" alt="image">
						</div>
						<div class="member_name">
							<h5> Robert Son</h5>
				...
				<div class="col-md-3">
					<div class="member_detail">
						<div class="member_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/member_4.png" width="300" alt="image">
						</div>
						<div class="member_name">
							<h5> John Capone</h5>
							<p> Web Art Director</p>
			...
			<div class="col-md-12">
				...
				<div class="testimonial_slide">
					<div class="testi_detail">
						<div class="testi_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/testi_img1.png" width="300" alt="image">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				$our_blog = new WP_Query('posts_per_page=3');

				while ($our_blog -> have_posts()) : $our_blog -> the_post();?>
					...
					<article class="our_blog">
						...
						<div class="blog_detail">
							<div class="category_heading">
								...
								<ul>
									<li> <i class="fa fa-clock-o" aria-hidden="true"></i><?php the_time('j F Y'); ?></li>
								</ul>
								
								<a href="<?php the_permalink(); ?>" class="read_more"> <p> Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i> </p> </a>
							</div>
						</div>
					</article>					
				</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-4">
								<div class="workng_img">
									<img src="<?php echo get_template_directory_uri(); ?>/images/contact_img.png" width="300" alt="logoimage">
								</div>
				</div>
